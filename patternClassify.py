...
def patternClassify(cloneIndex):
    ...
    if len(tarckerResult['similarityList']) - tarckerResult['negative_search_num'] > 1: # ptn 2 3 4 5
        ...
        reasonSenmentSet = set()
        for similarityItem in tarckerResult['similarityList']:
            reasonSenmentSet.add(similarityItem['reasonSegment'])
        
        if len(reasonSenmentSet) == 1: # 2 4 6
...
if __name__ == "__main__":
    ...
    report.append("Ptn2: " + str(len(result_dict[2]) + len(result_dict[4])))
    report.append("Ptn3: " + str(len(result_dict[3]) + len(result_dict[5])))
    report.append("Ptn4: " + str(len(result_dict[6])))
    report.append("Ptn5: " + str(len(result_dict[7])))
    ...
    report.append(result_dict[2] + result_dict[4])
    report.append("--------------------")
    report.append("------Ptn3 List-----")
    report.append(result_dict[3] + result_dict[5])
    report.append("--------------------")
    report.append("------Ptn4 List-----")
    report.append(result_dict[6])
    report.append("--------------------")
    report.append("------Ptn5 List-----")
    report.append(result_dict[7])
    report.append("--------------------")
